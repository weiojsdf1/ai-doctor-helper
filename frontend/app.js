const I18N = {
  ar: {
    ...
    xrayKicker: 'الخطوة الأساسية', xrayTitle: '2. تحليل صورة الأشعة', mainStep: 'خطوة رئيسية', xrayImage: 'صورة أشعة الصدر', noXrayPreview: 'لا توجد معاينة للأشعة بعد', analyzeXray: 'تحليل الأشعة',
